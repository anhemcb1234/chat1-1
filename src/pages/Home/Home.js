                ...
                <div className="w-full p-4">
                  <div className="relative">
                    ...
                    <input
                      ...
                      type="text"
                      className="w-full mb-3 h-12 rounded focus:outline-none px-3 focus:shadow-md"
                      placeholder="Search..."
                    />{" "}
                  </div>
                  {user &&
                    user
                      .filter((x) =>
                        x.email.toUpperCase().includes(filter.toUpperCase())
                      )
                      .map((user, index) => {
                        return (
                          <div key={index}>
                              ...
                              >
                                <li className="flex w-full justify-between items-center bg-white mt-2 p-2 hover:shadow-lg rounded cursor-pointer transition">
                                  <div className="flex w-full items-center justify-between ml-2">
                                    ...
                                    <div
                                      className={user.status ? green : red}
                                    ></div>
                                  </div>
                                </li>
                              </ul>
